...
const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    'dashboard.newAppointment': 'Programare Nouă',
    ...
    'appointments.newAppointment': 'Programare Nouă',
    'appointments.editAppointment': 'Editează Programare',
    ...
    'appointments.selectClient': 'Selectează client',
    'appointments.selectService': 'Selectează serviciu',
    'appointments.chooseDate': 'Alege o dată',
    'appointments.notesOptional': 'Note (opțional)',
    'appointments.addNotes': 'Adaugă note...',
    'appointments.validation.selectClient': 'Selectează un client',
    'appointments.validation.selectService': 'Selectează un serviciu',
    'appointments.validation.selectDate': 'Selectează o dată',
    'appointments.validation.enterTime': 'Introdu ora',
    
    // Clients
    'clients.title': 'Clienți',
    'clients.new': 'Client Nou',
    'clients.newClient': 'Client Nou',
    'clients.editClient': 'Editează Client',
    'clients.name': 'Nume',
    ...
    'clients.fullName': 'Nume complet',
    'clients.namePlaceholder': 'Ex: Maria Popescu',
    'clients.phonePlaceholder': 'Ex: 0722 123 456',
    'clients.emailOptional': 'Email (opțional)',
    'clients.emailPlaceholder': 'Ex: maria@email.com',
    'clients.notesOptional': 'Note (opțional)',
    'clients.notesPlaceholder': 'Ex: Preferă programări dimineața, alergii...',
    'clients.validation.nameMin': 'Numele trebuie să aibă minim 2 caractere',
    'clients.validation.phoneMin': 'Numărul de telefon trebuie să aibă minim 6 cifre',
    'clients.validation.emailInvalid': 'Email invalid',
  ...
  ru: {
    ...
    'appointments.newAppointment': 'Новая Запись',
    'appointments.editAppointment': 'Редактировать Запись',
    ...
    'appointments.selectClient': 'Выберите клиента',
    'appointments.selectService': 'Выберите услугу',
    'appointments.chooseDate': 'Выберите дату',
    'appointments.notesOptional': 'Заметки (опционально)',
    'appointments.addNotes': 'Добавить заметки...',
    'appointments.validation.selectClient': 'Выберите клиента',
    'appointments.validation.selectService': 'Выберите услугу',
    'appointments.validation.selectDate': 'Выберите дату',
    'appointments.validation.enterTime': 'Введите время',
    ...
    'clients.namePlaceholder': 'Напр: Мария Попеску',
    'clients.phonePlaceholder': 'Напр: 0722 123 456',
    'clients.emailOptional': 'Email (опционально)',
    'clients.emailPlaceholder': 'Напр: maria@email.com',
    'clients.notesOptional': 'Заметки (опционально)',
    'clients.notesPlaceholder': 'Напр: Предпочитает утренние записи, аллергии...',
    'clients.validation.nameMin': 'Имя должно содержать минимум 2 символа',
    'clients.validation.phoneMin': 'Телефон должен содержать минимум 6 цифр',
    'clients.validation.emailInvalid': 'Неверный email',
  ...
  en: {
    ...
    'appointments.selectClient': 'Select client',
    'appointments.selectService': 'Select service',
    'appointments.chooseDate': 'Choose a date',
    'appointments.notesOptional': 'Notes (optional)',
    'appointments.addNotes': 'Add notes...',
    'appointments.validation.selectClient': 'Select a client',
    'appointments.validation.selectService': 'Select a service',
    'appointments.validation.selectDate': 'Select a date',
    'appointments.validation.enterTime': 'Enter time',
    ...
    'clients.namePlaceholder': 'E.g.: Maria Popescu',
    'clients.phonePlaceholder': 'E.g.: 0722 123 456',
    'clients.emailOptional': 'Email (optional)',
    'clients.emailPlaceholder': 'E.g.: maria@email.com',
    'clients.notesOptional': 'Notes (optional)',
    'clients.notesPlaceholder': 'E.g.: Prefers morning appointments, allergies...',
    'clients.validation.nameMin': 'Name must have at least 2 characters',
    'clients.validation.phoneMin': 'Phone number must have at least 6 digits',
